          ...
          <div className="row align-items-center justify-content-center">
            ...
            <div className="col-xl-6 col-lg-7">
              <div className="about__content">
                ...
                <p className="desc">
                  At The Digital Coaching, we connect you with expert tutors who
                  tailor their teaching style to your unique needs. Our online
                  platform makes learning flexible and enjoyable, helping you
                ...
                <ul className="about__info-list list-wrap">
                  <li className="about__info-list-item">
                    ...
                    <p className="content">Award Winning Support.</p>
                  </li>
                  <li className="about__info-list-item">
                    <div className="icon">
                      <i className="flaticon-file" />
                    </div>
                    <p className="content">Flexible Learning Plans.</p>
                  </li>
                  <li className="about__info-list-item">
                    <div className="icon">
                      <i className="flaticon-graduation-cap" />
                    </div>
                    <p className="content">Personalized Live Classes.</p>
                  </li>
                  <li className="about__info-list-item">
                    <div className="icon">
                      <i className="flaticon-video-player" />
                    </div>
                    <p className="content">Recorded Lessons</p>
                  </li>
                </ul>
